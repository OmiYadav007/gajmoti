                            ...
                            @if ($digital_payment['status'] == 1)
                                <label class="payment-item">
                                    ...
                                    <div class="payment-item-card">
                                        ...
                                        <div class="content">
                                            <div class="digital_payment_btn">
                                                <h6 class="subtitle">{{translate('Online_payment')}}</h6>
                                                <p>
                                            ...
                                            <div class="d--none" id="digital_payment">
                                                        ...
                                                        <div class="col-xl-3 col-md-4 col-6">
                                                            <div
                                                                ...
                                                                <form method="post"
                                                                    ...
                                                                    <button class="bg-transparent border-0 h-100 w-100 px-2" type="submit">
                                                ...
                                                <div
                                                    ...
                                                    <span>{{translate('pay_with_secure_Online_payment_gateways')}}</span>
