                    ...
                    <div class="col-lg-6">
                        <div class="ps-xl-5">
                            <div class="footer-bottom-wrapper text-capitalize">
                                ...
                                <div class="footer-widget ">
                                    <h5 class="title">{{ translate('Quick Links') }}</h5>
                                    <ul class="links">
                                        <li>
                                ...
                                <div class="footer-widget ">
                                    <h5 class="title">{{ translate('Our Policies') }}</h5>
                                    <ul class="links">
                                ...
                                <div class="footer-widget">
                                 ...
                                 <div class="footer-widget">
                                    <h5 class="title">{{ translate('Grievance/Enquiry') }}</h5>
                                    <ul class="links">
                                        <li>
                                            <a href="mailto:general@gajmoti.in">General</a>
                                        </li>
                                         <li>
                                            <a href="mailto:corporate @gajmoti.in">Corporate </a>
                                        </li>
                                         <li>
                                            <a href="mailto:grievance @gajmoti.in">Grievance  </a>
                                        </li>
                                    </ul>
                                </div>
