                ...
                <ul class="menu me-xl-4">
                    ...
                    @if($web_config['brand_setting'])
                        ...
                        @if(count($brandList) > 0)
                            <li>
                                <a href="javascript:">{{ translate('collection')}}</a>
                                <ul class="submenu">
                        ...
                        @else
                            <li>
                                <a href="{{ route('brands') }}"
                                   class="{{ Request::is('brands')?'active':'' }}">{{ translate('collection') }}</a>
                            </li>
                        @endif
                    @endif
                    <li>
                        <a href="{{route('products',['data_from'=>'discounted','page'=>1])}}"
                           class="{{ request('data_from')=='discounted'?'active':'' }}">
                            {{ translate('offers') }}
                            @if($web_config['total_discount_products'] > 0)
