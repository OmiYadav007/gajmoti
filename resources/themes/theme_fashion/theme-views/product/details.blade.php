                    ...
                    <div class="product-single-pricing-inner text-capitalize">
                        ...
                        <h3 class="price"><span
                            ...
                            <sub>( {{ translate('vat') }} <span
                                    class="tax_status">{{ $product->tax_model == 'include' ? 'incl.' : webCurrencyConverter($product->tax)}}</span>
                                )</sub></h3>
                                    ...
                                    <li>
                                        ...
                                        <div class="cont">
                                            ...
                                            <span class="mt-1"> {{ translate('start_from') }} <span
                                                    ...
                                                    id="product_delivery_cost">{{webCurrencyConverter($deliveryInfo['delivery_cost'])}}</span></span>
                                        </div>
                                    </li>
